...
const features = [
  {
    ...
    tint: 'artist-card-green',
    iconWell: 'bg-artist-green/15 text-artist-green',
  },
  {
    icon: Sparkles,
  ...
  },
  {
    ...
    iconWell: 'bg-artist-yellow/15 text-artist-yellow',
  },
  {
    icon: Receipt,
    title: 'Billing Desk',
    ...
    iconWell: 'bg-artist-orange/15 text-artist-orange',
  },
  {
    icon: MessageSquare,
    title: 'Touchpoints',
